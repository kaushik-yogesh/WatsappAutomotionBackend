...
const agentSchema = new mongoose.Schema({
  ...
  knowledgeBase: [{
    ...
    textData: String, // Extracted text content (for PDF, text prompts)
    fileType: { type: String, enum: ['pdf', 'video', 'image', 'text', 'document'] },
...
agentSchema.index({ whatsappAccounts: 1 });
