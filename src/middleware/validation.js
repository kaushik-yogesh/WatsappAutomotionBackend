...
const schemas = {
  ...
  createAgent: Joi.object({
    ...
    whatsappAccountId: Joi.string().optional(),
    whatsappAccountIds: Joi.array().items(Joi.string()).optional(),
    telegramAccount: Joi.string().allow(null, '').optional(),
    instagramAccount: Joi.string().allow(null, '').optional(),
    facebookAccount: Joi.string().allow(null, '').optional(),
    youtubeAccount: Joi.string().allow(null, '').optional(),
